...
> AGI Cockpit 4.85.0で2026-09-20に確認済み。 [公式ドキュメントを表示](https://agi-labo.com/tools/cockpit/docs/initial-setup)
...
ローカル機能だけを使う場合は、最後の画面で「サインインせずに始める」を選べます。スマートルーティング、Autorun、または別端末からのリモートアクセスを使う場合は、AGIラボ会員としてサインインします。
