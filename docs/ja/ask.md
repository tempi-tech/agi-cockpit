...
> AGI Cockpit 4.88.0で2026-09-23に確認済み。 [公式ドキュメントを表示](https://agi-labo.com/tools/cockpit/docs/ask)
...
Askは単なる通知ではありません。質問は回答されるまで保持され、Desktopの専用Askウィンドウ、PWAの「受信箱」、設定済みのDiscordまたはSlackから応答できます。
