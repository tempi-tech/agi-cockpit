...
> AGI Cockpit 4.44.0で2026-08-03に確認済み。 [公式ドキュメントを表示](https://agi-labo.com/tools/cockpit/docs/getting-started)
...
Qoder CLIも「ネイティブUI」と「ターミナル」の両方に対応しています。ネイティブUIではQoderで利用可能なモデル、システムプロンプト、承認モードを選べます。推論レベル、service tier、アカウントプロファイルは利用できません。
